<?php
class Payment_Model_Payment extends Zend_Db_Table{
	protected $_name = 'dos_module_payment';
	...
	public function menuAdmin(){
        $menu[] = array('url'=>'payment', 'name'=>'Bài viết', 'nameen'=>'Post', 'namefr'=>'Post', 'num'=>$this->countItem());
        return $menu;
    }
