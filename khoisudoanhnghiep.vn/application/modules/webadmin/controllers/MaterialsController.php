<?php
class Webadmin_MaterialsController extends GLT_Controller_Backend{
	protected $_data;
	protected $_module;
	...
	public function addcatAction(){
    	...
    	if ($this->_request->isPost()) {
    		$validate  = new Materials_Form_MaterialsCatValidate($this->_data);
	...
	public function addAction(){
    	...
    	if($this->_request->isPost()){
    		$validate  = new Materials_Form_MaterialsValidate($this->_data);
    		if($validate->isError()==true){
    			$this->view->error = $validate->getError();
				$this->view->items = $validate->getData();
    		}else{
