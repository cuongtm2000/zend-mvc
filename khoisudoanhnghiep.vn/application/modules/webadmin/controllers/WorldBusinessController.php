...
class Webadmin_WorldBusinessController extends GLT_Controller_Backend {
    ...
    public function addcatAction() {
        ...
        if ($this->_request->isPost()) {
            $validate = new WorldBusiness_Form_CatValidate($this->_data);
    ...
    public function addAction() {
        ...
        if ($this->_request->isPost()) {
            $validate = new WorldBusiness_Form_Validate($this->_data);
    ...
    public function commentAction() {// echo'<pre>';		print_r($this->_data);		echo'</pre>';
        ...
        $cmt = new WorldBusiness_Model_Comments();
        $stu = new WorldBusiness_Model_WorldBusiness();
