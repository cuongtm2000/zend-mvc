...
--
-- Table structure for table `dos_module_consulting`
--

CREATE TABLE IF NOT EXISTS `dos_module_consulting` (
  `record_id` int(11) NOT NULL AUTO_INCREMENT,
...
--
-- Table structure for table `dos_module_consulting_cat`
--

CREATE TABLE IF NOT EXISTS `dos_module_consulting_cat` (
...
--
-- Table structure for table `dos_module_entertainment`
--

CREATE TABLE IF NOT EXISTS `dos_module_entertainment` (
  `record_id` int(11) NOT NULL AUTO_INCREMENT,
  `pic_thumb` varchar(45) DEFAULT NULL,
  `title` varchar(100) NOT NULL,
  `titleen` varchar(100) DEFAULT NULL,
...
--
-- Table structure for table `dos_module_entertainment_cat`
--

CREATE TABLE IF NOT EXISTS `dos_module_entertainment_cat` (
  `cat_id` int(11) NOT NULL AUTO_INCREMENT,
  `cat_parent_id` int(11) NOT NULL DEFAULT '0',
  `cat_title` varchar(45) NOT NULL,
  `cat_titleen` varchar(45) DEFAULT NULL,
...
--
-- Table structure for table `dos_module_experience`
--

CREATE TABLE IF NOT EXISTS `dos_module_experience` (
  `record_id` int(11) NOT NULL AUTO_INCREMENT,
  `pic_thumb` varchar(45) DEFAULT NULL,
  `title` varchar(100) NOT NULL,
  `titleen` varchar(100) DEFAULT NULL,
...
--
-- Table structure for table `dos_module_experience_cat`
--

CREATE TABLE IF NOT EXISTS `dos_module_experience_cat` (
  `cat_id` int(11) NOT NULL AUTO_INCREMENT,
  `cat_parent_id` int(11) NOT NULL DEFAULT '0',
  `cat_title` varchar(45) NOT NULL,
  `cat_titleen` varchar(45) DEFAULT NULL,
...
--
-- Table structure for table `dos_module_knows`
--

CREATE TABLE IF NOT EXISTS `dos_module_knows` (
  `record_id` int(11) NOT NULL AUTO_INCREMENT,
  `pic_thumb` varchar(45) DEFAULT NULL,
  `title` varchar(100) NOT NULL,
  `titleen` varchar(100) DEFAULT NULL,
...
--
-- Table structure for table `dos_module_knows_cat`
--

CREATE TABLE IF NOT EXISTS `dos_module_knows_cat` (
  `cat_id` int(11) NOT NULL AUTO_INCREMENT,
  `cat_parent_id` int(11) NOT NULL DEFAULT '0',
  `cat_title` varchar(45) NOT NULL,
  `cat_titleen` varchar(45) DEFAULT NULL,
...
ALTER TABLE `dos_module_handbook`
  ADD CONSTRAINT `dos_module_handbook_ibfk_1` FOREIGN KEY (`dos_module_item_cat_cat_id`) REFERENCES `dos_module_handbook_cat` (`cat_id`);
