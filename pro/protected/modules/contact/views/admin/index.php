        ...
        <tbody>
            <?php if ($models): ?>
                ...
                foreach ($models as $value): ?>
                    <?php $rowClass =  ($value['enable'] == 0) ? ' class="disable"' : (($i % 2 == 0) ? '' : ' class="alt"'); $title = ($value['hot'] == 1) ? '<strong>' . $value->ContactLanguage[Yii::app()->language]['title'] . '</strong> <img src="' . Yii::app()->theme->baseUrl . '/images/hot.gif" alt="Hot" />' : $value->ContactLanguage[Yii::app()->language]['title'];?>
                    <tr<?php echo $rowClass ?>>
                        ...
                        <td><?php echo $value->ContactLanguage[Yii::app()->language]['hit'] ?></td>
