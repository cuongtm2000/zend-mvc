    ...
    <table>
        ...
        <?php if ($models): ?>
            ...
            foreach ($models as $value): ?>
                ...
                if ($value['hot'] == 1) {
                    $title = '<strong>' . $value->ServicesLanguage[Yii::app()->language]['title'] . '</strong> <img src="' . Yii::app()->theme->baseUrl . '/images/hot.gif" alt="Hot" />';
                } else {
                    $title = $value->ServicesLanguage[Yii::app()->language]['title'];
                }
                ?>
