	...
	<div id="page">
		...
		<div id="banner">
			<ul class="slider">
				...
				<li class="slider-item"><img src="<?php echo Yii::app()->theme->baseUrl; ?>/images/banner1.jpg" alt="banner"/></li>
				<li class="slider-item"><img src="<?php echo Yii::app()->theme->baseUrl; ?>/images/banne2.jpg" alt="banner"/></li>
			</ul>
			<!--End slider banner-->
			<div class="video">
				<a href="http://youtu.be/_-UIaGgRxkA" rel="prettyPhoto" title="Khoa Thương Mại điện tử - ĐH Thương Mại"><img src="<?php echo Yii::app()->theme->baseUrl; ?>/images/video.jpg" alt="Khoa Thương Mại điện tử - ĐH Thương Mại"/></a>
