<?php
class Solution_IndexController extends GLT_Controller_Action {
    private $_data;
    private $_config;
    private $_paginator;
	...
	public function catAction() {
		...
		$this->webTitle($this->view->detailcat['cat_title'].' - '.$this->view->lang['solution']);
	}
	public function indexAction(){
		$this->webTitle($this->view->lang['solution']);
	}
	public function viewAction(){
		...
		$this->webTitle($detail['title'.LANG].' - '.$this->view->lang['solution']);
	}
}