<?php
class Webadmin_SolutionController extends GLT_Controller_Backend{
	protected $_data;
	protected $_module;
	...
	public function addcatAction(){
    	...
    	if ($this->_request->isPost()) {
    		$validate  = new Solution_Form_SolutionCatValidate($this->_data);
	...
	public function delcatAction(){
    	...
    	//cat_id for delete
    	$this->view->infocat = $cat->getInfoCat($this->_data); //TÃªn phÃ¢n loáº¡i
    	$this->view->numcat = $cat->countItemSub($this->_data); //Sá»‘ sáº£n pháº©m con
	...
	public function addAction(){
    	...
    	if($this->_request->isPost()){
    		$validate  = new Solution_Form_SolutionValidate($this->_data);
    		if($validate->isError()==true){
    			$this->view->error = $validate->getError();
				$this->view->items = $validate->getData();
    		}else{
