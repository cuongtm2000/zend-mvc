<?php
class Webadmin_PromotionsController extends GLT_Controller_Backend{
	protected $_data;
	protected $_module;
    ...
    public function indexAction(){
        $record = new Promotions_Model_Promotions();    
        //parse view
    ...
    public function addAction(){
    	...
    	$record = new Promotions_Model_Promotions();
	    if ($this->_request->isPost()) {
	   		$validate  = new Promotions_Form_PromotionsValidate($this->_data);
