...
class GLT_System_SmartCounter extends Zend_Db_Table{
   protected $_name = 'dos_sys_statistics';
    ...
    private $_TIME_TO_LIVE = 1800;//sau này dua vào config
	...
	private function update_counter (){
        //N?u chuy?n qua ngày m?i (>84600s) reset l?i b? d?m theo ngày
        ...
        $this->clean();//xóa các session có th?i gian trên 30p
    }
