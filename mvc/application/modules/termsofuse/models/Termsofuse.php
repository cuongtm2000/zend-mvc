<?php
class Termsofuse_Model_Termsofuse extends Zend_Db_Table{
	protected $_name = 'dos_module_termsofuse';
	...
	public function menuAdmin(){
        $menu[] = array('url'=>'termsofuse', 'name'=>'Bài viết', 'nameen'=>'Post', 'namefr'=>'Post', 'num'=>$this->countItem());
        return $menu;
    }
