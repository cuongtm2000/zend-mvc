<?php
class Wedding_Model_Wedding extends Zend_Db_Table{
	protected $_name = 'dos_module_wedding';
	...
	public function menuAdmin(){
        $menu[] = array('url'=>'wedding', 'name'=>'Bài viết', 'nameen'=>'Post', 'namefr'=>'Post', 'num'=>$this->countItem());
        return $menu;
    }
