<?php
class Webadmin_VideoController extends GLT_Controller_Backend{
	protected $_data;
	protected $_module;
    ...
    public function addcatAction(){
    	...
    	if ($this->_request->isPost()) {
    		$validate  = new Video_Form_VideoCatValidate($this->_data);
    ...
    public function addAction(){
    	...
    	if($this->_request->isPost()){
    		$validate  = new Video_Form_VideoValidate($this->_data);
    		if($validate->isError()==true){
    			$this->view->error = $validate->getError();
