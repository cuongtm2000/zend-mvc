<?php
class Webadmin_ProductionsController extends GLT_Controller_Backend{
	protected $_data;
	protected $_module;
	...
	public function addcatAction(){
    	...
    	if ($this->_request->isPost()) {
    		$validate  = new Productions_Form_ProductionsCatValidate($this->_data);
	...
	public function addAction(){
    	...
    	if($this->_request->isPost()){
    		$validate  = new Productions_Form_ProductionsValidate($this->_data);
    		if($validate->isError()==true){
    			$this->view->error = $validate->getError();
				$this->view->items = $validate->getData();
    		}else{
	...
	public function commentAction(){
		...
		$stu=new Productions_Model_Productions();
