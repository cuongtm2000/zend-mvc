					...
					<ul>
						...
						<li<?php echo $none?>><a<?php echo $selected ?> href="<?php echo (strpos($value['url'], 'http://') === false) ? (($value['url'] == 'default') ? Yii::app()->request->baseUrl.Yii::app()->session['langUrl'].'/' : Yii::app()->request->baseUrl.Yii::app()->session['langUrl'].'/'.Yii::t('user', $value['url'].'.link')) : $value['url'] ?>" title="<?php echo CHtml::encode($value['menu'.LANG]) ?>"<?php echo $target ?>><?php echo CHtml::encode($value['menu'.LANG]) ?></a>
							<?php if($value['url'] == 'about'):?>
								<ul>
									<?php foreach($this->about_list as $value):?>
							...
							<?php if($value['url'] == 'services'):?>
								<ul>
									<?php foreach($this->services_list as $value):?>
							...
							<?php if($value['url'] == 'news'):?>
								<ul>
									<?php foreach($this->news_list as $value):?>
										<li><a href="<?php echo Yii::app()->request->baseUrl.LANGURL ?>/<?php echo Yii::t('user', 'news.link')?>/<?php echo $value['tag'.LANG]?>" title="<?php echo $value['cat_title'.LANG]?>"><?php echo $value['cat_title'.LANG]?></a></li>
									<?php endforeach?>
								</ul>
							<?php endif?>
						</li>
