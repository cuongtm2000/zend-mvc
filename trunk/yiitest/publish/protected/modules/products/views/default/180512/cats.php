        ...
        <li class="product">
			<div class="product-img">
				<a href="<?php echo Yii::app()->request->baseUrl.LANGURL ?>/<?php echo Yii::t('user', $this->module->id . '.link')?>/<?php echo $value['tag'.LANG] ?>" title="<?php echo $value['cat_title'.LANG] ?>">
					...
					<?php else :?>
						<img src="<?php echo Yii::app()->theme->baseUrl; ?>/images/no-product.png" alt="<?php echo $value['cat_title'.LANG] ?>" />
					<?php endif; ?>
				</a>
			</div>
            ...
            <li class="product">							
				<div class="product-img">
					<a href="<?php echo Yii::app()->request->baseUrl . LANGURL . '/' . Yii::t('user', $this->module->id . '.link') . '/' . $info_cat['tag'.LANG] ?>/<?php echo $value['tag'.LANG] ?>.html" title="<?php echo $value['title'.LANG] ?>">
						...
						<?php else :?>
							<img src="<?php echo Yii::app()->theme->baseUrl; ?>/images/no-product.png" alt="<?php echo $value['title'.LANG] ?>" />
						<?php endif; ?>
					</a>
				</div>									
				...
				<p class="button-cart"><a href="<?php echo Yii::app()->baseUrl . LANGURL?>/<?php echo Yii::t('user', 'products.link')?>/<?php echo Yii::t('user', 'products.order.link')?>/<?php echo $value['tag'.LANG] ?>" title="<?php echo $this->lang['detail']?>: <?php echo $value['title' . LANG] ?>" class="add-to-cart"><span><?php echo $this->lang['addcart']?></span></a></p>
		  </li>
        <?php endforeach; ?>
