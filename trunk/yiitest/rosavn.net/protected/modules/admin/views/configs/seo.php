	...
	<div class="tab_container">
		...
		<ul id="tab<?php echo $i?>" class="tab_content">
			...
			<li>
				...
				<textarea name="description<?php echo $lang?>[]" cols="90" rows="6"><?php echo $value['description'.$lang] ?></textarea>
			</li>
			<?php endforeach?>
		</ul>
		<?php $i++; endforeach; ?>
		<label>&nbsp;</label><input type="submit" name="submit" value="  <?php echo $this->lang['update'] ?>  " title="<?php echo $this->lang['update'] ?>" class="submit" />
	</div>
</div> <!--En tab-->
</form>