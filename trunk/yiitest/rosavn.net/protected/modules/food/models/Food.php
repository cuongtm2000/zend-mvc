 ...
 * @property DosModuleFoodCat $dosModuleItemCatCat
 */
class Food extends CActiveRecord {
	...
	public function relations() {
		...
		return array(
			'FoodCat' => array(self::BELONGS_TO, 'FoodCat', 'dos_module_item_cat_cat_id'),
		);
	}
