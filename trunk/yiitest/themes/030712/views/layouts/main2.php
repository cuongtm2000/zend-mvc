    	...
    	<div id="header">
			...
			<p class="hot-line"><?php echo $this->lang['company_phone']?></p>
            	<!--<form action="" method="get" class="frm-search">
                	<input type="text" name="search" class="go" value="Search entire store here ..." onblur="if(this.value=='') this.value='Search entire store here ...'" onfocus="if(this.value =='Search entire store here ...' ) this.value=''"/><a  href="#" title="" class="btgo">GO</a>
