...
<div id="wrapper">
    <div id="header">
        ...
        <?php echo ($this->lang['company_name']) ? '<h1 class="title-company">'.$this->lang['company_name'].'</h1>' : '' ?> <!--End title company--> <div class="clear"></div>	
    </div><!--End header-->
    <div class="hder-bttom">
    	<div class="lang">
	...
	<div id="content">
		...
		<div id="leftcontent">
			<?php if(isset($this->function['menu_about']) && ($this->function['menu_about'])):?>
				...
				<div class="bt-left-penal"></div><!--End bd title list-->
			<?php endif;?>
