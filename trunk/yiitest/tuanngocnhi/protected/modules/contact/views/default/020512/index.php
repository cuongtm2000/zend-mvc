	...
	<?php $form = $this->beginWidget('CActiveForm', array('id'=>'frm', 'enableAjaxValidation'=>true, 'enableClientValidation' =>true));?>
		...
		<p><?php echo $this->lang['contact_msg']?></p>
			<ul class="frame-contact">
				...
				<li>
					<label>&nbsp;</label>
					<?php echo CHtml::submitButton(Yii::t('user', 'send'), array('name'=>'submit', 'class'=>'bton-dk', 'title'=>Yii::t('user', 'send'))); ?>
					<?php echo CHtml::resetButton(Yii::t('user', 'reset'), array('name'=>'reset', 'class'=>'bton-dk', 'title'=>Yii::t('user', 'reset'))); ?>
				</li>					
			</ul>               
	   <?php $this->endWidget();?>
</div>
