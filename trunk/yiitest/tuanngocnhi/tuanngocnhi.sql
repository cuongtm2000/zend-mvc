...
('contact', 'tuanngocnhi'),
('news', 'tuanngocnhi'),
('products', 'tuanngocnhi'),
('services', 'tuanngocnhi'),
('supports', 'tuanngocnhi'),
('video', 'tuanngocnhi');
...
('Trang chủ', '', 'default', '', 1, NULL, NULL, NULL, NULL, 'tuanngocnhi'),
('Giới thiệu', '', 'about', '', 2, NULL, NULL, NULL, NULL, 'tuanngocnhi'),
('Sản phẩm', '', 'products', '', 3, NULL, NULL, NULL, NULL, 'tuanngocnhi'),
('Xi mạ', '', 'services', '', 4, NULL, NULL, NULL, NULL, 'tuanngocnhi'),
('Nổi bật', '', 'productshot', '', 5, NULL, NULL, NULL, NULL, 'tuanngocnhi'),
('Sự kiện', '', 'news', '', 6, NULL, NULL, NULL, NULL, 'tuanngocnhi'),
('Liên hệ', '', 'contact', '', 7, NULL, NULL, NULL, NULL, 'tuanngocnhi');
...
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 AUTO_INCREMENT=5593 ;
...
(5592, 'aassasa', '', '2012-08-21 01:30:26', '', '', NULL, '<p>sasasa</p>', '', '<p>saasa</p>', '', 'aassasa', '', '', '', 0, 1, '', 1, NULL, NULL, NULL, NULL, NULL, 1, 1073);
...
('tuanngocnhi', 'minhtnn10@gmail.com', 'e10adc3949ba59abbe56e057f20f883e', '2012-06-19 06:42:21', 'Phòng k.Doanh : Mr Minh', '0974851777', 'CÔNG TY TRÁCH NHIỆM HỮU HẠN TUẤN NGỌC NHI', 'user', 'vi|en', '', '2012-08-30 16:00:00', 0, '20122012', '', 1, '020512', 19, 'co-khi-may-moc-thiet-bi');
...
('address1', '519 F - Ấp Ngũ Phúc Xã Hố Nai 3 - H. Trảng Bom - Tỉnh Đồng Nai', '', 'tuanngocnhi'),
('address2', 'Điện thoại: Mr Minh :0974851777 - Ms Dung : 0983589322 <br />Website: www.tuanngocnhi.com - Email: minhtnn10@gmail.com', '', 'tuanngocnhi'),
('advs', 'Phần Quảng Cáo', '', 'tuanngocnhi'),
('company_name', '', '', 'tuanngocnhi'),
('company_name_footer', 'CÔNG TY TNHH TUẤN NGỌC NHI', '', 'tuanngocnhi'),
('company_phone', 'Hotline: 0903 613 438', '', 'tuanngocnhi'),
('contact', 'Liên hệ', '', 'tuanngocnhi'),
('copyright', 'Copyright © 2012 DOS.VN , Thuonghoi Corp', '', 'tuanngocnhi'),
('developed', 'Developed by', '', 'tuanngocnhi'),
('services', 'Xi Mạ', '', 'tuanngocnhi'),
('supports', 'Hỗ Trợ Trực Tuyến', '', 'tuanngocnhi');
