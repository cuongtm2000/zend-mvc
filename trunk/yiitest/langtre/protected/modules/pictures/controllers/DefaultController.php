...
class DefaultController extends Controller {
    ...
    public function actionOrder($id) {
        ...
        $this->redirect(Yii::app()->request->baseUrl . LANGURL . '/' . Yii::t('user', 'pictures.link') . '/' . Yii::t('user', 'pictures.cartitem.link'));
    }
    ...
    public function actionCartitem() {
        ...
        if (isset($_POST['num_of_dates'])) {
            ...
            Yii::app()->session['cart'] = $cart;
            $this->redirect(Yii::app()->request->baseUrl . LANGURL . '/' . Yii::t('user', 'pictures.link') . '/' . Yii::t('user', 'pictures.ordering.link'));
        }
        ...
        if (isset($_POST['CartForm'])) {
            ...
            if ($cartform->validate()) {
                ...
                foreach ($items as $k => $v) {
                    ...
                    $html .= '<tr align="center"><td>' . $v['title' . LANG] . ' - ' . $v['PicturesCat']['cat_title' . LANG] . '</td><td>' . Common::getPrice($price) . '</td><td>' . $num_of_dates . '</td><td>' . Common::getPrice($total_item) . '</td></tr>';
                }
