...
class Bussiness extends CActiveRecord {
	...
	public function listCats($type = 0) {
		if ($type != 0) {
			$this->_data[] = array('bussiness_id' => 'root', 'bussiness_name' => '-- Vui lòng chọn ngành nghề --');
		}
	...
	public function detailItem($id) {
		$command = Yii::app()->db->createCommand('SELECT bussiness_name FROM ' . $this->tableName() . ' WHERE bussiness_id=:business');
		$command->bindParam(":business", $id, PDO::PARAM_STR);
