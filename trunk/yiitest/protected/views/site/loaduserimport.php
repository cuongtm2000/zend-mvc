<?php if($userImport):?>
	<?php $checked = ''; foreach($userImport as $value):?>
		<li class="anan">
			<label for="tem-<?php echo $value['username']?>"><img src="<?php echo Yii::app()->baseUrl; ?>/public/userfiles/images/<?php echo $value['username']?>/images/demo.jpg" alt="<?php echo $value['username']?>"  /></label>
			<div class="hover">
