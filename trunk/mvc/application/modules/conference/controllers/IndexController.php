<?php
class Conference_IndexController extends GLT_Controller_Action {
    private $_data;
    private $_lang;
	...
	public function indexAction() {
		$record = new Conference_Model_Conference();
        
        //First record
        $this->view->item = $record->getFristRecord();
           
        $this->view->headTitle()->prepend(html_entity_decode($this->_lang[$this->_data['module']]));
	}
