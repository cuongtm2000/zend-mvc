<?php
class Conference_Model_Conference extends Zend_Db_Table{
	protected $_name = 'dos_module_conference';
	...
	public function menuAdmin(){
        $menu[] = array('url'=>'conference', 'name'=>'Bài viết', 'nameen'=>'Post', 'namefr'=>'Post', 'num'=>$this->countItem());
        return $menu;
    }
