...
<fieldset>
    ...
    <div class="col2">
        <?php echo $form->fileField($model, 'banner_url', array('class'=>'fileupload', 'size'=>'33%')); ?>
        <?php echo $form->textField($model, 'txt_file_name', array('class'=>'txt-large')) ?>
        <?php echo $form->checkBox($model, 'change_file_name') ?> <?php echo $form->labelEx($model, 'change_file_name', array('class'=>'remove')) ?>
    </div>
    <div class="clear space"></div>
