...
class GLT_Model_News extends Zend_Db_Table{
   ...
   //Front end - Get bản tin nhiều người xem
	...
	public function addItem($data = NULL){
    	...
    	$data = array('pic_thumb' => $file_thumb, 'title' => $this->_xss->purify(stripslashes(trim($data['title']))), 'titleen' => $this->_xss->purify(trim(stripslashes($data['titleen']))), 'titlefr' => $this->_xss->purify(trim(stripslashes($data['titlefr']))), 'preview' => $this->_xss->purify(stripslashes($data['preview'])), 'previewen' => $this->_xss->purify($data['previewen']), 'previewfr' => $this->_xss->purify($data['previewfr']), 'content' => $this->_xss->purify(stripslashes($data['detail'])), 'contenten' => $this->_xss->purify($data['detailen']), 'contentfr' => $this->_xss->purify($data['detailfr']), 'tag' => $this->_xss->purify($data['tag']), 'description' => $this->_xss->purify($data['description']), 'record_order' => $max_record, 'record_type' => $this->_xss->purify($data['hot']), 'enable' => $this->_xss->purify($data['active']), 'dos_module_item_cat_cat_id' => $this->_xss->purify($data['parentcat']));
    	$this->insert($data);
    }
	...
	public function saveItem($data = NULL){
    	...
    	$where = 'record_id = '.$data['id'];
    	$data = array('pic_thumb' => $file_thumb, 'title' => $this->_xss->purify(trim(stripslashes($data['title']))), 'titleen' => $this->_xss->purify(trim(stripslashes($data['titleen']))), 'titlefr' => $this->_xss->purify(trim(stripslashes($data['titlefr']))), 'preview' => $this->_xss->purify(stripslashes($data['preview'])), 'previewen' => $this->_xss->purify($data['previewen']), 'previewfr' => $this->_xss->purify($data['previewfr']), 'content' => $this->_xss->purify(stripslashes($data['detail'])), 'contenten' => $this->_xss->purify($data['detailen']), 'contentfr' => $this->_xss->purify($data['detailfr']), 'tag' => $this->_xss->purify(trim($data['tag'])), 'description' => $this->_xss->purify($data['description']), 'record_type' => $this->_xss->purify($data['hot']), 'enable' => $this->_xss->purify($data['active']), 'dos_module_item_cat_cat_id' => $this->_xss->purify($data['parentcat']));
    	$this->update($data, $where);
    }
