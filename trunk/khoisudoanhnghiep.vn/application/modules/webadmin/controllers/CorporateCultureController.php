<?php
class Webadmin_CorporateCultureController extends GLT_Controller_Backend{
	private $_data;
	private $_module;
	private $_controller;
	private $_action;
	...
	public function addcatAction(){
    	...
    	if ($this->_request->isPost()) {
    		$validate  = new CorporateCulture_Form_CatValidate($this->_data);
	...
	public function addAction(){
    	...
    	if($this->_request->isPost()){
    		$validate  = new CorporateCulture_Form_Validate($this->_data);
