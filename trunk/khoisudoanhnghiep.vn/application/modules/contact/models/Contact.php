...
class Contact_Model_Contact extends Zend_Db_Table{
	...
	public function addItem($data = NULL){   	
    	$data = array('title' => $this->_xss->purify($data['title']), 'titleen' => $this->_xss->purify($data['titleen']), 'titlefr' => $this->_xss->purify($data['titlefr']), 'content' => $this->_xss->purify(stripslashes($data['detail'])), 'contenten' => $this->_xss->purify($data['detailen']), 'contentfr' => $this->_xss->purify($data['detailfr']), 'hot' => $this->_xss->purify($data['hot']), 'enable' => $this->_xss->purify($data['active']));
    	$this->insert($data);
    }
