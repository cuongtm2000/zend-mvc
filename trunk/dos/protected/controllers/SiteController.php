...
class SiteController extends HomeController {
	...
	public function actionIndex() {
		...
		$this->render('index', array('listBusiness' => $business_class->listCats()));
	}
	...
	public function actionsignup() {
		...
		$this->render('signup', array('model' => $model, 'listBusiness' => $business_class->listCats(), 'listProvinces' => $province_class->listProvinceByCountry('VND')));
	}
	...
	public function actionLoadTemplates() {
		$this->renderPartial('loadtemplates');
	}
