...
<ul class="panel-items">
	...
	<li>
		...
		<a href="<?php echo Yii::app()->baseUrl.$this->setUrlModule('news').'/'.$value->NewsCat->NewsCatLanguage[Yii::app()->language]['tag'].'/'.$value->NewsLanguage[Yii::app()->language]['tag'].'.html'?>" ><img class="detail" src="<?php echo Yii::app()->theme->baseUrl?>/images/button-detail.png" alt="Chi tiết" /></a><div class="clear"></div>
	</li>
	<?php endforeach?>
