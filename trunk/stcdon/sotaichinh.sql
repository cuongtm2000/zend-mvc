...
--
-- Host: 127.0.0.1
-- Generation Time: Dec 06, 2012 at 04:44 AM
...
('lands_num_item_new', '4', NULL, 'lands'),
...
('product_mana_cat_height_thumb', '150', NULL, 'product_management'),
('product_mana_cat_width_thumb', '150', NULL, 'product_management'),
('product_mana_height_thumb', '200', NULL, 'product_management'),
('product_mana_num_item_cat', '3', NULL, 'product_management'),
('product_mana_num_item_hot', '7', NULL, 'product_management'),
('product_mana_num_item_index', '3', NULL, 'product_management'),
('product_mana_num_item_new', '7', NULL, 'product_management'),
('product_mana_width_thumb', '150', NULL, 'product_management'),
...
('menu_product_mana', 'Product_managementCat', '', 'listItem', 'product_management'),
...
('code', 'Quản lý sàn sản phẩm', 0, 'vi'),
...
('product_management', 'Quản lý sản phẩm', 0, 'vi'),
...
('product_management', 'Danh mục|Danh sách|Cấu hình', 'product_management/cat|product_management|product_management/config', 4, 1, 1),
...
(8, 'A2 - 4D', '2012-11-15 01:40:25', 6, 'chua-giao-dich'),
(9, 'A2 - 2A', '2012-11-15 01:59:50', 1, 'chua-giao-dich'),
(10, 'A2 - 2H', '2012-11-15 02:00:04', 2, 'da-dat-cho'),
(11, 'A2 - 2M', '2012-11-15 02:00:21', 3, 'chua-giao-dich'),
(12, 'A2 - 4A', '2012-11-15 02:00:40', 4, 'chua-giao-dich'),
(13, 'A2 - 4B', '2012-11-15 02:00:51', 5, 'da-dat-cho'),
(14, 'A2 - 4G', '2012-11-15 02:01:40', 7, 'da-giao-dich'),
(15, 'A2 - 4F', '2012-11-15 02:01:53', 8, 'da-giao-dich'),
(16, 'A2 - 5A', '2012-11-15 02:02:12', 9, 'da-giao-dich'),
(17, 'A2 - 5D', '2012-11-15 02:02:34', 10, 'da-giao-dich'),
(18, 'A2 - 5F', '2012-11-15 02:02:47', 11, 'da-dat-cho');
...
(1, 'Mua bán', '0000-00-00 00:00:00', 1, 1),
(2, 'Cho thuê', '0000-00-00 00:00:00', 2, 1);
...
(36, 'vi', 'Thành tựu và định hướng', 'du-an', 'Mo ta dự án'),
(37, 'vi', 'Tin tức', 'tin-tuc', 'Tin tức'),
(38, 'vi', 'Giới thiệu', 'gioi-thieu', ''),
(41, 'vi', 'Văn bản mới ban hành', 'tuyen-dung', 'Mô tả tuyển dụng'),
...
(3, 0, '2012-11-10 01:57:08', '', NULL, 0, 3, NULL, NULL, 1),
(4, 0, '2012-11-10 01:57:17', '', NULL, 0, 4, NULL, NULL, 1);
...
--
-- Table structure for table `hoiit_module_product_management`
--

CREATE TABLE IF NOT EXISTS `hoiit_module_product_management` (
  `record_id` int(11) NOT NULL AUTO_INCREMENT,
  `postdate` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP,
  `pic_thumb` varchar(100) DEFAULT NULL,
  `pic_desc` varchar(500) DEFAULT NULL,
  ...
  `hoiit_module_item_cat_cat_id` int(11) NOT NULL,
  PRIMARY KEY (`record_id`),
  KEY `fk_hoiit_module_mana_hoiit_module_mana_cat_1` (`hoiit_module_item_cat_cat_id`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 AUTO_INCREMENT=24 ;

-- --------------------------------------------------------

--
-- Table structure for table `hoiit_module_product_management_cat`
--

CREATE TABLE IF NOT EXISTS `hoiit_module_product_management_cat` (
  `cat_id` int(11) NOT NULL AUTO_INCREMENT,
  `cat_parent_id` int(11) NOT NULL DEFAULT '0',
  `cat_created` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP,
  `pic_thumb` varchar(100) DEFAULT NULL,
...
--
-- Table structure for table `hoiit_module_product_management_cat_languages`
--

CREATE TABLE IF NOT EXISTS `hoiit_module_product_management_cat_languages` (
  `cat_id` int(11) NOT NULL,
  `language_id` varchar(2) NOT NULL,
  `cat_title` varchar(100) NOT NULL,
  `preview` text,
  ...
  `description` varchar(250) DEFAULT NULL,
  PRIMARY KEY (`cat_id`,`language_id`),
  KEY `fk_hoiit_module_mana_cat_has_hoiit_languages_hoiit_languages1` (`language_id`),
  KEY `fk_hoiit_module_mana_cat_has_hoiit_languages_hoiit_module_ne1` (`cat_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

-- --------------------------------------------------------

--
-- Table structure for table `hoiit_module_product_management_languages`
--

CREATE TABLE IF NOT EXISTS `hoiit_module_product_management_languages` (
  `record_id` int(11) NOT NULL,
  `language_id` varchar(2) NOT NULL,
  `title` varchar(100) NOT NULL,
  `preview` text,
  ...
  `extra_field2` varchar(100) DEFAULT NULL,
  PRIMARY KEY (`record_id`,`language_id`),
  KEY `fk_hoiit_module_mana_has_hoiit_languages_hoiit_languages1` (`language_id`),
  KEY `fk_hoiit_module_mana_has_hoiit_languages_hoiit_module_mana1` (`record_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
('footer', 1, '1', 'news', '', '', 'counter_session'),
('left', 2, '1', 'news', '', '', 'menu_news'),
('left', 3, '1', 'news', '', '', 'adv_left'),
...
('<product_management:(quan-ly-san-pham)>', 'product_management/default/index', '', 5, 1, 'product_management', 'vi'),
('<product_management:(quan-ly-san-pham)>/<cid:[-a-z0-9]+>', 'product_management/default/cats', '', 3, 0, 'product_management', 'vi'),
('<product_management:(quan-ly-san-pham)>/<cid:[-a-z0-9]+>/<id:[-a-z0-9]+>', 'product_management/default/view', 'urlSuffix=>.html', 6, 0, 'product_management', 'vi'),
('<product_management:(quan-ly-san-pham)>/<cid:[-a-z0-9]+>/trang/<page:\\d+>', 'product_management/default/cats', '', 2, 0, 'product_management', 'vi'),
('<product_management:(quan-ly-san-pham)>/trang/<page:\\d+>', 'product_management/default/index', '', 4, 0, 'product_management', 'vi'),
...
--
-- Constraints for table `hoiit_module_product_management`
--
ALTER TABLE `hoiit_module_product_management`
  ADD CONSTRAINT `fk_hoiit_module_mana_hoiit_module_mana_cat_1` FOREIGN KEY (`hoiit_module_item_cat_cat_id`) REFERENCES `hoiit_module_product_management_cat` (`cat_id`) ON DELETE NO ACTION ON UPDATE NO ACTION;

--
-- Constraints for table `hoiit_module_product_management_cat_languages`
--
ALTER TABLE `hoiit_module_product_management_cat_languages`
  ADD CONSTRAINT `fk_hoiit_module_mana_cat__has_hoiit_languages_hoiit_languages1` FOREIGN KEY (`language_id`) REFERENCES `hoiit_languages` (`language_id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  ADD CONSTRAINT `fk_hoiit_module_mana_cat__has_hoiit_languages_hoiit_module_ne1` FOREIGN KEY (`cat_id`) REFERENCES `hoiit_module_product_management_cat` (`cat_id`) ON DELETE NO ACTION ON UPDATE NO ACTION;

--
-- Constraints for table `hoiit_module_product_management_languages`
--
ALTER TABLE `hoiit_module_product_management_languages`
  ADD CONSTRAINT `fk_hoiit_module_mana_has_hoiit_languages_hoiit_languages1` FOREIGN KEY (`language_id`) REFERENCES `hoiit_languages` (`language_id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  ADD CONSTRAINT `fk_hoiit_module_mana_has_hoiit_languages_hoiit_module_mana1` FOREIGN KEY (`record_id`) REFERENCES `hoiit_module_product_management` (`record_id`) ON DELETE NO ACTION ON UPDATE NO ACTION;
