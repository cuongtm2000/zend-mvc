...
/**
 * This is the model class for table "hoiit_module_procedures_cat_languages".
 *
 * The followings are the available columns in table 'hoiit_module_procedures_cat_languages':
 ...
 */
class ProceduresCatLanguage extends CActiveRecord {
    /**
     * Returns the static model of the specified AR class.
     * @param string $className active record class name.
     * @return ProceduresCatLanguage the static model class
     */
    ...
    public function tableName() {
        return 'hoiit_module_procedures_cat_languages';
    }
