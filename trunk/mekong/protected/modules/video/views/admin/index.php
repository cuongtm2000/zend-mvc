            ...
            <?php if($models): ?>
                <?php $i=1; foreach($models as $value): ?>
                    <?php 
                        ...
                        if($value->hot == 1){
            	    		$title = '<strong>'.$value->VideoLanguage[Yii::app()->language]['title'].'</strong> <img src="'.Yii::app()->theme->baseUrl.'/images/hot.gif" alt="Hot" />';
            	    	}else{
            	        	$title = $value->VideoLanguage[Yii::app()->language]['title'];
            	    	}
                    ?>
                    <tr<?php echo $rowclass ?>>
                        ...
                        <td><?php echo $value->VideoCat->VideoCatLanguage[Yii::app()->language]['cat_title'] ?></td>
                        <td><?php echo $value->VideoLanguage[Yii::app()->language]['hit'] ?></td>
