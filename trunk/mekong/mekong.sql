...
('adv_left_width', '288', NULL, 'adv'),
('adv_right_height', '200', NULL, 'adv'),
('adv_right_width', '265', NULL, 'adv'),
...
('video_hot', 'Video', '', 'firstHotRecord', 'video');
...
('title', 'Title', 1, 'en'),
('title', 'Tiêu đề', 1, 'vi'),
('typical_projects', 'Typical projects', 0, 'en'),
('typical_projects', 'Dự án tiêu biểu', 0, 'vi'),
('video', 'Video', 0, 'en'),
('video', 'Video', 0, 'vi'),
('view', 'View', 1, 'en'),
('view', 'Lượt xem', 1, 'vi');
...
('video', 'Danh mục|Danh sách|Cấu hình|Cấu hình Url', 'video/cat|video|video/config|video/url', 3, 1, 1);
...
(18, '9001', '9001.jpg', '', '2012-07-20 01:54:15', '2012-07-18 17:00:00', '2012-09-24 17:00:00', 0, 4, 'right', '_bank', 0, 1),
(19, 'Khu biet thu Phu My Hung', 'khu-biet-thu-phu-my-hung-5.jpg', '', '2012-07-22 02:16:26', '2012-07-28 16:00:00', '2012-10-29 16:00:00', 0, 5, 'left', '_bank', 0, 1),
...
(38, 'en', '', '', ''),
(38, 'vi', 'Cửa sổ mở quay vào trong', 'san-pham/cua-so-mo-quay-vao-trong', ''),
(39, 'en', '', '', ''),
(39, 'vi', 'Cửa sổ mở trượt', 'san-pham/cua-so-mo-truot', ''),
(40, 'en', '', '', ''),
(40, 'vi', 'Cửa sổ mở hất ra ngoài', 'san-pham/cua-so-mo-hat-ra-ngoai', ''),
(41, 'en', '', '', ''),
(41, 'vi', 'Cửa sổ mở quay lật vào trong', 'san-pham/cua-so-mo-quay-lat-vao-trong', ''),
(42, 'en', '', '', ''),
(42, 'vi', 'Cửa mở trượt', 'san-pham/cua-mo-truot', ''),
(43, 'en', '', '', ''),
(43, 'vi', 'Cửa chống đạn', 'san-pham/cua-chong-dan', ''),
(44, 'en', '', '', ''),
(44, 'vi', 'Cửa sổ mở quay ra ngoài', 'san-pham/cua-so-mo-quay-ra-ngoai', ''),
(45, 'en', '', '', ''),
(45, 'vi', 'Cửa nhôm gỗ', 'san-pham/cua-nhom-go', ''),
(46, 'en', '', '', ''),
(46, 'vi', 'Cửa nhôm Domal', 'san-pham/cua-nhom-domal', ''),
(47, 'en', '', '', ''),
(47, 'vi', 'Cửa đi 2 cánh mở quay', 'san-pham/cua-di-2-canh-mo-quay', '');
...
(4, '2012-08-08 02:58:58', 'peppa-pig-standard-playhouse-thumb.jpg', 'peppa-pig-standard-playhouse.jpg', NULL, 4, '110000', 0, NULL, NULL, NULL, NULL, NULL, 1, 5),
...
(18, 0, '2012-09-11 02:32:21', '', NULL, 0, 21, NULL, NULL, 1),
(19, 0, '2012-09-11 02:32:55', '', NULL, 0, 20, NULL, NULL, 1),
(20, 0, '2012-09-11 02:33:39', '', NULL, 0, 19, NULL, NULL, 1),
(21, 0, '2012-09-11 02:36:15', '', NULL, 0, 18, NULL, NULL, 1);
...
(5, 'en', 'Door 2 Door open back', '', 'door-2-door-open-back', 'Door 2 Door open back'),
(5, 'vi', 'Cửa đi 2 cánh mở quay', '', 'cua-di-2-canh-mo-quay', 'Cửa đi 2 cánh mở quay'),
(6, 'en', '', '', '', ''),
...
(18, 'en', 'Inward opening window', '', 'inward-opening-window', 'Inward opening window'),
(18, 'vi', 'Cửa sổ mở quay vào trong', '', 'cua-so-mo-quay-vao-trong', 'Cửa sổ mở quay vào trong'),
(19, 'en', 'Sliding windows', '', 'sliding-windows', 'Sliding windows'),
(19, 'vi', 'Cửa sổ mở trượt', '', 'cua-so-mo-truot', 'Cửa sổ mở trượt'),
(20, 'en', 'Top hung windows', '', 'top-hung-windows', 'Top hung windows'),
(20, 'vi', 'Cửa sổ mở hất ra ngoài', '', 'cua-so-mo-hat-ra-ngoai', 'Cửa sổ mở hất ra ngoài'),
(21, 'en', 'Tilt &amp; turn inward opening window', '', 'tilt-turn-inward-opening-window', 'Tilt &amp; turn inward opening window'),
(21, 'vi', 'Cửa sổ mở quay lật vào trong', '', 'cua-so-mo-quay-lat-vao-trong', 'Cửa sổ mở quay lật vào trong');
...
(6, 'vi', 'Kids Toy Pianoasas', '<p>Pin hoạt động khá màu hồng xe đạp quad với các họa tiết cổ tích, mà là hoạt động với một máy gia tốc chân. Nó đi kèm với một pin sạc và bộ sạc 6V và có tốc độ tối đa là 2km / h</p>', '<p>Trang chủ Giao hàng tận nơi chỉ phát. Giao hàng tận nơi hầu hết khách hàng tại Vương quốc Anh trong vòng 5 ngày làm việc.</p>\r\n<p>Xin lưu ý, chúng tôi chỉ có thể cung cấp mặt hàng này vào đất liền địa chỉ Vương quốc Anh. Sản phẩm này chỉ có sẵn để giao hàng cho đại lục Vương quốc Anh Không có Trả về phân minh ELC là hạnh phúc hoàn lại hoặc trao đổi bất kỳ hàng hóa không sử dụng trở lại trong vòng 28 ngày kể từ ngày mua khi sản xuất nhận của bạn, miễn là họ được trả về trong một điều kiện không sử dụng và trong bao bì gốc của họ.</p>\r\n<p>Xin vui lòng xem Điều khoản và Điều kiện để biết thêm chi tiết</p>', 'kids-toy-pianoasas', 'Pin hoạt động khá màu hồng xe đạp quad với các họa tiết cổ tích, mà là hoạt động với một máy gia tốc chân. Nó đi kèm với một pin sạc và bộ sạc 6V và có tốc độ tối đa là 2km / h', 0, NULL, NULL);
...
(56, 'vi', 'Dịch vụ', '<p>Đang cập nhật</p>', 'dich-vu', 'Đang cập nhật', 56, NULL, NULL);
...
INSERT INTO `hoiit_module_video` (`record_id`, `postdate`, `pic_thumb`, `pic_full`, `pic_desc`, `record_order`, `hot`, `specials`, `field1`, `field2`, `field3`, `field4`, `enable`, `hoiit_module_item_cat_cat_id`) VALUES
(8, '2012-09-10 08:16:48', 'asdasasasa-thumb.jpg', NULL, NULL, 1, 1, NULL, NULL, NULL, NULL, NULL, 1, 18);
...
(18, 0, '2012-09-10 08:07:58', 'danh-muc-video.jpg', NULL, 0, 18, NULL, NULL, 1);
...
(18, 'en', 'asdsad', '', 'asdsad', 'dasdsad'),
(18, 'vi', 'Danh muc Video', '', 'danh-muc-video', 'sadsa');
...
INSERT INTO `hoiit_module_video_languages` (`record_id`, `language_id`, `title`, `link`, `content`, `tag`, `description`, `hit`, `extra_field1`, `extra_field2`) VALUES
(8, 'en', 'assasasasasasa', '', '', 'assasasasasasa', 'asasss', 0, NULL, NULL),
(8, 'vi', 'asdasasasa', 'http://www.youtube.com/watch?v=GGtKxbu7vLI', '', 'asdasasasa', 'as', 0, NULL, NULL);
...
('right', 4, '1', 'about', NULL, NULL, 'adv_center'),
('right', 5, '1', 'about', NULL, NULL, 'list_support'),
('right', 1, '1', 'factory', NULL, NULL, 'adv_left'),
('right', 2, '1', 'factory', NULL, NULL, 'video_hot'),
('right', 3, '1', 'factory', NULL, NULL, 'adv_right'),
('right', 4, '1', 'factory', NULL, NULL, 'adv_center'),
('right', 5, '1', 'factory', NULL, NULL, 'list_support'),
('right', 1, '1', 'contact', NULL, NULL, 'adv_left'),
('right', 2, '1', 'contact', NULL, NULL, 'video_hot'),
('right', 3, '1', 'contact', NULL, NULL, 'adv_right'),
('right', 4, '1', 'contact', NULL, NULL, 'adv_center'),
('right', 5, '1', 'contact', NULL, NULL, 'list_support'),
('right', 1, '1', 'customer', NULL, NULL, 'adv_left'),
('right', 2, '1', 'customer', NULL, NULL, 'video_hot'),
('right', 3, '1', 'customer', NULL, NULL, 'adv_right'),
('right', 4, '1', 'customer', NULL, NULL, 'adv_center'),
('right', 5, '1', 'customer', NULL, NULL, 'list_support'),
('right', 1, '1', 'news', NULL, NULL, 'adv_left'),
('right', 2, '1', 'news', NULL, NULL, 'video_hot'),
('right', 3, '1', 'news', NULL, NULL, 'adv_right'),
('right', 4, '1', 'news', NULL, NULL, 'adv_center'),
('right', 5, '1', 'news', NULL, NULL, 'list_support'),
('right', 1, '1', 'products', NULL, NULL, 'adv_left'),
('right', 2, '1', 'products', NULL, NULL, 'video_hot'),
('right', 3, '1', 'products', NULL, NULL, 'adv_right'),
('right', 4, '1', 'products', NULL, NULL, 'adv_center'),
('right', 5, '1', 'products', NULL, NULL, 'list_support'),
('right', 1, '1', 'recruitment', NULL, NULL, 'adv_left'),
('right', 2, '1', 'recruitment', NULL, NULL, 'video_hot'),
('right', 3, '1', 'recruitment', NULL, NULL, 'adv_right'),
('right', 4, '1', 'recruitment', NULL, NULL, 'adv_center'),
('right', 5, '1', 'recruitment', NULL, NULL, 'list_support'),
('right', 1, '1', 'pictures', NULL, NULL, 'adv_left'),
('right', 2, '1', 'pictures', NULL, NULL, 'video_hot'),
('right', 3, '1', 'pictures', NULL, NULL, 'adv_right'),
('right', 4, '1', 'pictures', NULL, NULL, 'adv_center'),
('right', 5, '1', 'pictures', NULL, NULL, 'list_support'),
('right', 1, '1', 'service', NULL, NULL, 'adv_left'),
