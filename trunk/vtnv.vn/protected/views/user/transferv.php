...
<div class="frame-tent-right">
    ...
    <div class="row">
        <p class="my-price">Số tiền hiện tại của bạn là: <span><?php echo number_format($this->balance, 0, '', '.') ?> V</span></p>
    </div>
    <ul class="frame-contact">
        ...
        <li>
            ...
            <?php echo $form->textArea($model, 'message', array('cols' => 45, 'rows' => 6, 'maxlength' => 180)); ?>
