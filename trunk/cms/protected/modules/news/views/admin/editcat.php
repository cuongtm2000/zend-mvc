...
<fieldset>
    ...
    <div class="col2">
        <?php echo $form->dropDownList($model, 'cat_parent_id', CHtml::listData(NewsCat::model()->listCats(1, '|-- ', 1, $model['cat_id']), 'cat_id', 'cat_title_prefix')); ?>
    </div>
    ...
    <div class="col1"><?php echo $form->labelEx($model, 'cat_enable', array('for' => ucfirst($this->ID) . 'Cat_cat_enable_0')) ?></div>
