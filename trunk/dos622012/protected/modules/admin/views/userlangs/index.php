<div class="content">
	...
	$(document).ready(function(){
	    $("#add-rows").click(function(){
            $(".rows").before('<p><label>Lang</label><select name="lang_name[]"><?php $lang_lists = Langs::getLangs(0); foreach($lang_lists as $lang_list): ?><option value="<?php echo $lang_list['lang_name'] ?>"><?php echo $lang_list['lang_name'] ?> &raquo; <?php echo $lang_list['lang'.LANG] ?></option><?php endforeach; ?></select><input name="lang[]" value="" maxlength="200" class="txt-small" /> <input name="langen[]" value="" maxlength="200" class="txt-small" /></p>');
            return false;
	    });
	});
	</script>
