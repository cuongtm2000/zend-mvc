...
--
-- Host: 127.0.0.1
-- Generation Time: Dec 17, 2012 at 05:08 AM
...
('<services:(chinh-sach-ban-si)>/<cid:[-a-z0-9]+>/<id:[-a-z0-9]+>', 'services/default/view', 'urlSuffix=>.html', 0, 0, 'jobs', 'vi'),
