...
<?php if($items_hot):?>
<ul class="list-item">
    <?php foreach($items_hot['models'] as $item):?>
        <li>
...
<?php $this->widget('CLinkPager', array('pages' => $items_hot['pages'], 'header'=>'', 'lastPageLabel'=>Yii::t('user', 'last'), 'nextPageLabel'=>Yii::t('user', 'next'), 'firstPageLabel'=>Yii::t('user', 'first'), 'prevPageLabel'=>Yii::t('user', 'prev'), 'htmlOptions'=>array('class'=>'paging')))?> <div class="clear"></div>
