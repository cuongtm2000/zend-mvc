<h2 class="title-box"><span>Hàng mới về</span></h2>
<?php if($items_new):?>
<ul class="list-item">
	<?php foreach($items_new['models'] as $item):?>
		<li>
...
<?php $this->widget('CLinkPager', array('pages' => $items_new['pages'], 'header'=>'', 'lastPageLabel'=>Yii::t('user', 'last'), 'nextPageLabel'=>Yii::t('user', 'next'), 'firstPageLabel'=>Yii::t('user', 'first'), 'prevPageLabel'=>Yii::t('user', 'prev'), 'htmlOptions'=>array('class'=>'paging')))?> <div class="clear"></div>
...
<?php else:?>
    <div class="frame-tent-right">Không tồn tại mẫu tin</div>
<?php endif;?>
