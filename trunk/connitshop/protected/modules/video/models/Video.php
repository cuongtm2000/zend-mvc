...
/**
 * This is the model class for table "hoiit_module_video".
 *
 * The followings are the available columns in table 'hoiit_module_video':
 ...
 * @property HoiitModulevideoCat $hoiitModuleItemCatCat
...
class Video extends CActiveRecord {
    ...
    public function relations() {
        ...
        return array(
            ...
            'Language' => array(self::MANY_MANY, 'Language', 'hoiit_module_video_languages(record_id, language_id)'),
    ...
    public function listItemAdmin() {
        $criteria = new CDbCriteria();
        //$criteria->with = array('Language', 'VideoLanguage');
        $criteria->order = 'record_order DESC, postdate DESC';
