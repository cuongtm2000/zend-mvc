...
class Lands extends CActiveRecord {
    ...
    public function rules() {
        ...
        return array(
            array('hoiit_module_item_cat_cat_id, hoiit_module_item_type_type_id, hoiit_module_lands_provinces_province_id, username', 'required'),
    ...
    public function relations() {
        ...
        return array(
            ...
            'LandsUsers' => array(self::BELONGS_TO, 'LandsUsers', 'username'),
