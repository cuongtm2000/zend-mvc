...
<form name="frm" id="frm" action="" method="post">
    ...
    <table>
        ...
        <?php if ($models): $i = 1; foreach ($models as $value): ?>
            <?php $rowClass = ($value['enable'] == 0) ? $rowClass = ' class="disable"' : ($i % 2 == 0) ? '' : ' class="alt"'; $title = ($value['hot'] == 1) ? $title = '<strong>' . $value->AboutLanguage[Yii::app()->language]['title'] . '</strong> <img src="' . Yii::app()->theme->baseUrl . '/images/hot.gif" alt="Hot" />' : $value->AboutLanguage[Yii::app()->language]['title']; ?>
