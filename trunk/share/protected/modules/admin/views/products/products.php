            ...
            <?php if ($models): ?>
                ...
                foreach ($models as $value): ?>
                    ...
                    <tr<?php echo $rowclass ?>>
                        ...
                        <td><?php echo CHtml::link($title, array('/admin/products/edit', 'id' => $value->record_id)) ?></td>
                        <td><?php echo $value->ProductsCat['cat_title'] ?></td>
                        <td><?php echo $value->hits ?></td>
                        <td><?php echo CHtml::link($this->lang['edit'], array('/admin/products/edit', 'id' => $value->record_id)) ?></td>
                    </tr>
                    <?php $i++;
                endforeach; ?>
            <?php else: ?>
