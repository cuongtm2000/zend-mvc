        ...
        <table class="table-product">
            <tbody>
                <?php foreach ($list_items['models'] as $value): ?>
                    <tr>
                        <td width="100">
                            <div class="frame-img-pro"> <a href="<?php echo Yii::app()->baseUrl . LANGURL . '/' . Yii::t('user', $this->module->id . '.link') . '/' . $value->ProductsCat['tag' . LANG] ?>/<?php echo $value['tag' . LANG] ?>.html" title="<?php echo $value['title' . LANG] ?>">
