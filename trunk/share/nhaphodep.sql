...
--
-- Host: localhost
-- Generation Time: Jun 18, 2012 at 10:30 AM
...
(1, 'Giới thiệu sơ lược công ty', '', '<p>Kính thưa quý khách !</p>\r\n<p>Để đáp ứng nhu cầu về giao dịch bất động sản trong bối cảnh thị trường bất động sản ngày càng phát triển nhanh mạnh, nhu cầu mua, bán, thuê, cho thuê bất động sản ngày càng đa dạng và phong phú.</p>\r\n<p>Nhằm tiết kiệm thời gian và công sức cho quý khách hàng, có được những thông tin về sản phẩm hiệu quả, chính xác và với mong muốn quảng bá sản phẩm của quý khách hàng có thêm được cơ hội giao dịch thành công.</p>\r\n<p>Văn phòng dịch vụ bất động sản địa ốc Phố Quen ra đời. Và phương châm đặt khách hàng làm trung tâm với mong muốn mang đến sự thịnh vượng cho quý khách, văn phòng dịch vụ nhà đất Phố Quen chúng tôi sẽ hoạt động lấy tôn chỉ phục vụ khách hàng một cách tâm huyết nhất và cam kết mang lại những sản phẩm với giá trị theo đúng với giá trị thực tế của sản phẩm trên thị trường.</p>\r\n<p>Xin chân thành cảm ơn quý khách hàng đã ủng hộ trong suốt thời gian qua với niềm hân hoan và biết ơn</p>\r\n<p>Xin chân thành cảm ơn quý khách !</p>', '', 97, '2012-06-18 02:19:49', 1, 1, NULL, NULL, 'gioi-thieu-so-luoc-cong-ty', '', 'Để đáp ứng nhu cầu về giao dịch bất động sản trong bối cảnh thị trường bất động sản ngày càng phát triển nhanh mạnh, nhu cầu mua, bán, thuê, cho thuê bất động sản ngày càng đa dạng và phong phú.', '', 1, 'nhaphodep');
...
(2, '', '', '01230 456 789', 'bao6188', 2, 'skype', 'nhaphodep'),
(3, 'Hỗ trợ kinh doanh', '', '0909 999 888', 'groupitsoft', 1, 'yahoo', 'nhaphodep');
