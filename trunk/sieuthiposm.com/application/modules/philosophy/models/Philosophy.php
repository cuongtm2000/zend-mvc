<?php
class Philosophy_Model_Philosophy extends Zend_Db_Table{
	protected $_name = 'dos_module_philosophy';
	...
	public function menuAdmin(){
        $menu[] = array('url'=>'philosophy', 'name'=>'Bài viết', 'nameen'=>'Post', 'namefr'=>'Post', 'num'=>$this->countItem());
        return $menu;
    }
