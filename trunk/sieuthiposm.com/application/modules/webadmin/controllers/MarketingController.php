<?php
class Webadmin_MarketingController extends GLT_Controller_Backend{
	protected $_data;
	protected $_module;
	...
	public function addcatAction(){
    	...
    	if ($this->_request->isPost()) {
    		$validate  = new Marketing_Form_MarketingCatValidate($this->_data);
	...
	public function addAction(){
    	...
    	if($this->_request->isPost()){
    		$validate  = new Marketing_Form_MarketingValidate($this->_data);
    		if($validate->isError()==true){
    			$this->view->error = $validate->getError();
				$this->view->items = $validate->getData();
    		}else{
	...
	public function commentAction(){
		...
		$stu=new Marketing_Model_Marketing();
		...
		foreach($allCmt as  &$value){
			$value['dos_module_marketing_record_id']=$stu->getItem($value['dos_module_marketing_record_id']);
		}
