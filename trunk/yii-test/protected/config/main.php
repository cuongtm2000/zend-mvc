...
return array(
	...
	'modules'=>array(
		'default', 'about', 'products', 'services', 'banner', 'admin',
	...
	'components'=>array(
		...
		'urlManager'=>array(
			...
			'rules'=>array(
                ...
                'http://<subdomain:\w+>.thanhansoft.com/<language:(vi|en)>/<module:\w+>'=>'<module>/default/index',
                ...
                'http://<subdomain:\w+>.thanhansoft.com/<language:(vi|en)>/<module:\w+>/<cname:[-a-z0-9]+>/page/<page:\d+>'=>array('<module>/default/cats'), //paging
                'http://<subdomain:\w+>.thanhansoft.com/<language:(vi|en)>/<module:\w+>/<cname:[-a-z0-9]+>'=>array('<module>/default/cats'),
                'http://<subdomain:\w+>.thanhansoft.com/<module:\w+>/<cname:[-a-z0-9]+>/page/<page:\d+>'=>array('<module>/default/cats'), //paging
                'http://<subdomain:\w+>.thanhansoft.com/<module:\w+>/<cname:[-a-z0-9]+>'=>array('<module>/default/cats'),
