...
<div id="wrapper">
        ...
        <div id="header">
            ...
            <div class="clear"></div>
                <div class="logo"><a href="<?php echo Yii::app()->request->baseUrl ?>/" title=""><img src="<?php echo Yii::app()->theme->baseUrl; ?>/images/logo.png" alt="Logo" /></a></div>
                <ul class="menu">
        	...
        	<div id="leftcontent">
                ...
                <?php if(isset($this->function['advs_left']) && ($this->function['advs_left'])):?>
                    ...
                    <?php foreach($this->function['advs_left'] as $value): ?>
                        <p class="mycart">You have no items in your shopping cart.</p>
                    <?php endforeach; ?>
                <?php endif;?>
