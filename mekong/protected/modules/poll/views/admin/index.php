    ...
    <table>
        ...
        <?php if ($models): ?>
            ...
            <tr<?php echo $rowclass ?>>
                ...
                <td><?php echo CHtml::link($value->question, array('edit', 'id' => $value->record_id)) ?></td>
                <td><?php echo date('d-m-Y', microtime($value['create_date'])) ?></td>
                <td><?php echo date('d-m-Y', ($value['begin_date'])) ?></td>
