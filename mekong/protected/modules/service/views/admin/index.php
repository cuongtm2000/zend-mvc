    ...
    <table>
        ...
        <?php if ($models): ?>
            ...
            foreach ($models as $value): ?>
                ...
                if ($value['hot'] == 1) {
                    $title = '<strong>' . $value->ItemLanguage[Yii::app()->language]['title'] . '</strong> <img src="' . Yii::app()->theme->baseUrl . '/images/hot.gif" alt="Hot" />';
                } else {
                    $title = $value->ItemLanguage[Yii::app()->language]['title'];
                }
                ?>
            <tr<?php echo $rowclass ?>>
                ...
                <td><?php echo $value->ItemLanguage[Yii::app()->language]['hit'] ?></td>
