...
function selected_item() {
    ...
    alert("Vui lòng chọn một mẩu tin");
    return false;
}
function delete_list(the_url) {
    if (selected_item()) {
        question = confirm("Bạn có chắc chắn xóa mẩu tin này?\n Lưu ý, việc xóa tài khoản này sẽ đồng thời xóa tất cả các bài viết liên quan tới tài khoản và không thể khôi phục");
        if (question != "0") {
