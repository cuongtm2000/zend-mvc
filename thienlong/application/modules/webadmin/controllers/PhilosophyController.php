<?php
class Webadmin_PhilosophyController extends GLT_Controller_Backend{
	protected $_data;
	protected $_module;
    ...
    public function indexAction(){
        $record = new Philosophy_Model_Philosophy();    
        //parse view
    ...
    public function addAction(){
    	...
    	$record = new Philosophy_Model_Philosophy();
	    if ($this->_request->isPost()) {
	   		$validate  = new Philosophy_Form_PhilosophyValidate($this->_data);
