...
/**
 * This is the model class for table "hoiit_module_projects".
 *
 * The followings are the available columns in table 'hoiit_module_projects':
 ...
 * @property HoiitModuleProjectsCat $hoiitModuleItemCatCat
...
class Projects extends CActiveRecord {
    ...
    public function rules() {
        ...
        return array(
            ...
            array('pic_desc, field1, field2, field3, field4', 'length', 'max' => 500),
    ...
    public function relations() {
        ...
        return array(
            'ProjectsCat' => array(self::BELONGS_TO, 'ProjectsCat', 'hoiit_module_item_cat_cat_id'),
            'ProjectsLanguage' => array(self::HAS_MANY, 'ProjectsLanguage', 'record_id', 'index' => 'language_id'),
        );
    }
    ...
    public function listItemsHot() {
        ...
        $criteria->limit = Config::getValue('projects_num_item_hot');
    ...
    public function listItemsIndex() {
        ...
        $pages->pageSize = Config::getValue('projects_num_item_index');
    ...
    public function listItemByCat($cid) {
        ...
        // elements per page
        $pages = new CPagination($count);
        $pages->pageSize = Config::getValue('projects_num_item_cat');
        $pages->applyLimit($criteria);
    ...
    private function deleteRecord($id) {
        ProjectsLanguage::model()->deleteRecord($id);
    ...
    public function saveRecord($model, $id = null) {
        ...
        ProjectsLanguage::model()->saveRecord($id, $model);
    }
