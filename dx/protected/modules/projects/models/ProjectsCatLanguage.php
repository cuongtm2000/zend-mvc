...
/**
 * This is the model class for table "hoiit_module_projects_cat_languages".
 *
 * The followings are the available columns in table 'hoiit_module_projects_cat_languages':
 ...
 */
class ProjectsCatLanguage extends CActiveRecord {
    /**
     * Returns the static model of the specified AR class.
     * @param string $className active record class name.
     * @return ProjectsCatLanguage the static model class
     */
    ...
    public function tableName() {
        return '{{module_projects_cat_languages}}';
    }
