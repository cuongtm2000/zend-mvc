...
/**
 * This is the model class for table "hoiit_module_projects_languages".
 *
 * The followings are the available columns in table 'hoiit_module_projects_languages':
 ...
 */
class ProjectsLanguage extends CActiveRecord {
    /**
     * Returns the static model of the specified AR class.
     * @param string $className active record class name.
     * @return ProjectsLanguage the static model class
     */
    ...
    public function tableName() {
        return '{{module_projects_languages}}';
    }
