...
return array(
    ...
    '<products:(san-pham)>/<cid:[-a-z0-9]+>/<id:[-a-z0-9]+>' => array('products/default/view', 'urlSuffix' => '.html'), //view
	 ...
	 //pictures modules
    '<pictures:(hinh-anh)>' => 'pictures/default/index', //index
    '<pictures:(hinh-anh)>/<cid:(dat-hang)>/<id:[-a-z0-9]+>' => array('pictures/default/order'), //order
    '<pictures:(hinh-anh)>/<cid:(gio-hang)>' => array('pictures/default/cartitem'), //Cart item
    '<pictures:(hinh-anh)>/<cid:(xoa-gio-hang)>' => array('pictures/default/delallcart'), //Delete all cart
    '<pictures:(hinh-anh)>/<cid:(thong-tin-dat-hang)>' => array('pictures/default/ordering'), //purchase
    '<pictures:(hinh-anh)>/<cid:[-a-z0-9]+>/trang/<page:\d+>' => array('pictures/default/cats'), //cat paging
    '<pictures:(hinh-anh)>/<cid:[-a-z0-9]+>' => array('pictures/default/cats'), //cat
    '<pictures:(hinh-anh)>/<cid:[-a-z0-9]+>/<id:[-a-z0-9]+>' => array('pictures/default/view', 'urlSuffix' => '.html'), //view
