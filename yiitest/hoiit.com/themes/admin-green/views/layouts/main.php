...
<html xmlns="http://www.w3.org/1999/xhtml">
    ...
    <body>
        <div id="wapper">
            <div id="header">
                <div class="logo"><a href="<?php echo Yii::app()->request->baseUrl ?>/administrator"><img src="<?php echo Yii::app()->theme->baseUrl; ?>/images/logo.png" alt="Logo" /></a> <strong>Administrator</strong></div>
                <div class="frmlogin">
                    ...
                    <a href="<?php echo Yii::app()->request->baseUrl ?>/logout" title="Thoát">Thoát</a>
                </div>
            </div>
            <ul id="tabs">
            ...
            <div class="paddinglr10">
                <div class="menu-bar">
                    <div id="catmenu">
                        <ul class="menu-li"> 
                            <li><a href="<?php echo Yii::app()->request->baseUrl ?>/administrator/posts">Posting</a>
                                <ul>
                                    <li><a href="<?php echo Yii::app()->request->baseUrl ?>/administrator/posts">List post</a></li>
                                </ul>
                            </li>
