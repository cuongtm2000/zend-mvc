...
<h2 class="title-box"><span><?php echo ($item) ? $item['title' . LANG] : $this->lang[$this->module->id] ?></span></h2>
<div class="frame-tent-right">
	<?php if($item):?>
	<div id="frame-info-contact"><?php echo $item['content' . LANG] ?></div>
	<?php endif;?>

	<?php $form = $this->beginWidget('CActiveForm', array('id'=>'frmsignup', 'enableAjaxValidation'=>true, 'enableClientValidation' =>true));?>
	...
	<ul class="frame-contact">
		...
		<li>
			<label>&nbsp;</label>
			<?php echo CHtml::submitButton(Yii::t('main', 'send'), array('name'=>'submit', 'class'=>'submit', 'title'=>Yii::t('main', 'send'))); ?>
			<?php echo CHtml::resetButton(Yii::t('main', 'reset'), array('name'=>'reset', 'class'=>'submit', 'title'=>Yii::t('main', 'reset'))); ?>
		</li>
	</ul>
	<?php $this->endWidget();?>
