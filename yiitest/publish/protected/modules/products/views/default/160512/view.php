	...
	<div class="frame-pro-info">
		...
		<div class="row-info">
			...
			<div class="right-info">
				...
				<p><a href="<?php echo Yii::app()->baseUrl . LANGURL?>/<?php echo Yii::t('user', 'products.link')?>/<?php echo Yii::t('user', 'products.order.link')?>/<?php echo $item['tag'.LANG] ?>" title="<?php echo $this->lang['detail']?>: <?php echo $item['title' . LANG] ?>" class="add-to-cart"><span><?php echo $this->lang['addcart']?></span></a></p>
