...
<fieldset>
    ...
    <div class="col1"><?php echo $form->labelEx($model, 'cat_title'.$lang) ?></div>
    <div class="col2">
    ...
    <div class="col2">
        <?php if ($model->pic_thumb): ?>
			<div class="img-marginb5"><img src="<?php echo Yii::app()->request->baseUrl . USERFILES. '/'.$this->ID.'Cat/' . $model->pic_thumb ?>" alt="<?php echo $model->cat_title?>" />
