...
<ul id="list-template">
	...
	<?php foreach($templatesBusiness['models'] as $value):?>
		<li>
			<a href="<?php echo $value['dos_bussiness_bussiness_id']?>/<?php echo $value['template']?>.html" title="<?php echo $value['template_name']?>"><img src="<?php echo Yii::app()->baseUrl; ?>/themes/<?php echo $value['template']?>/images/tiny.png" alt="<?php echo $value['template']?>"  /></a>
			<p><a href="<?php echo $value['dos_bussiness_bussiness_id']?>/<?php echo $value['template']?>.html" title="<?php echo $value['template_name']?>"><strong><?php echo $value['template_name']?></strong></a></p>
		</li>
		<?php endforeach?>
	<?php else:?>
