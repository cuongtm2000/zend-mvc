<?php if($userImport):?>
	<?php $checked = ''; foreach($userImport as $value):?>
		<li class="anan">
			<label for="tem-<?php echo $value['username']?>"><img src="<?php echo Yii::app()->baseUrl; ?>/public/userfiles/image/<?php echo $value['username']?>/image/demo.png" alt="<?php echo $value['username']?>" /></label>
			<div class="hover">
