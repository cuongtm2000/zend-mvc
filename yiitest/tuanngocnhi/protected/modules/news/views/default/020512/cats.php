...
<div class="frame-tent-right">
	...
	<ul class="masuring">
		...
		<li>
			...
			<h2 class="title-masuring"><a href="<?php echo Yii::app()->request->baseUrl . LANGURL . '/' . Yii::t('user', $this->module->id . '.link') . '/' . $value[ucfirst($this->module->id).'Cat']['tag'.LANG] ?>/<?php echo $value['tag'.LANG] ?>.html" title='<?php echo $value['title'.LANG] ?>'><strong><?php echo $value['title'.LANG] ?></strong></a></h2>
