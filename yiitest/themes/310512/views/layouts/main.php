...
<body>
	<div id="wapper">	
    		<div id="header" >
                ...
                <?php if($this->logo):?>
					<a href="<?php echo Yii::app()->request->baseUrl.Yii::app()->session['langUrl']?>/" title="<?php echo $this->logo['banner_name']?>"><img id="logo" src="<?php echo Yii::app()->baseUrl.USERFILES ?>/banner/<?php echo $this->logo['banner_url'] ?>" alt="<?php echo $this->logo['banner_name']?>" /></a>
				<?php else:?>
					<a href="<?php echo Yii::app()->request->baseUrl.Yii::app()->session['langUrl'] ?>/" title="Logo"><img id="logo" src="<?php echo Yii::app()->theme->baseUrl; ?>/images/logo.gif" alt="Logo" /></a>
				<?php endif; ?>
            </div> <!--end header-->
            <ul id="nav">
            ...
            <div id="content">
            	...
            	<div id="rightcontent">
					...
					<h3 class="title-right"><span><?php echo $this->lang['supports'] ?></span></h3>
					<ul class="support">
					...
					<h3 class="title-right"><span><?php echo $this->lang['counter'] ?></span></h3>
					<ul class="statistics">
            ...
            <div id="foo">
                <ul id="nav-fter">
                    <?php $size = count($this->nav); $i = 0; foreach($this->nav as $value):?>
					<?php $target = ($value['target']=='') ? '' : ' target="'.$value['target'].'"'; ?>
					<?php $none = ($i < ($size-1)) ? '' : ' class="none-line-fter"' ?>
