            ...
            <?php if($models): ?>
                <?php $i=1; foreach($models as $value): ?>
                    ...
                    <tr<?php echo $rowclass ?>>
                        ...
                        <td><a href="<?php echo Yii::app()->request->baseUrl ?>/<?php echo $this->module->getName() ?>/<?php echo $this->ID ?>/edit/id/<?php echo $value['banner_id'] ?>" title="Chỉnh sửa">Chỉnh sửa</a></td>
                    </tr>
                <?php $i++;endforeach; ?>
            <?php else: ?>
