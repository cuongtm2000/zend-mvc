...
class Advs extends CActiveRecord{
	...
	public function rules(){
		...
		return array(
			...
			array('title, ttileen', 'length', 'max'=>100),
			...
			array('record_id, title, ttileen, pic_thumb, url, create_date, start_date, end_date, hits, record_order, position, type, enable, dos_usernames_username', 'safe', 'on'=>'search'),
		);
	}
	...
	public function search(){
		...
		$criteria->compare('ttileen',$this->ttileen,true);
