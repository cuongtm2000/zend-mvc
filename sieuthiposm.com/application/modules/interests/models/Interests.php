<?php
class Interests_Model_Interests extends Zend_Db_Table{
	protected $_name = 'dos_module_interests';
	...
	public function menuAdmin(){
        $menu[] = array('url'=>'interests', 'name'=>'Bài viết', 'nameen'=>'Post', 'namefr'=>'Post', 'num'=>$this->countItem());
        return $menu;
    }
