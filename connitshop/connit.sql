...
--
-- Host: 127.0.0.1
-- Generation Time: Dec 18, 2012 at 03:31 AM
...
('banner_height_default', '240', NULL, 'banner'),
('banner_width', '480', NULL, 'banner'),
('banner_width_default', '755', NULL, 'banner'),
...
('jobs_cat_height_thumb', '110', NULL, 'jobs'),
('jobs_cat_width_thumb', '110', NULL, 'jobs'),
('jobs_height_thumb', '110', NULL, 'jobs'),
('jobs_num_item_cat', '3', NULL, 'jobs'),
('jobs_num_item_hot', '7', NULL, 'jobs'),
('jobs_num_item_index', '3', NULL, 'jobs'),
('jobs_num_item_new', '7', NULL, 'jobs'),
('jobs_width_thumb', '110', NULL, 'jobs'),
...
('procedures_cat_height_thumb', '100', NULL, 'procedures'),
('procedures_cat_width_thumb', '150', NULL, 'procedures'),
('procedures_height_thumb', '100', NULL, 'procedures'),
('procedures_num_item_cat', '5', NULL, 'procedures'),
('procedures_num_item_hot', '7', NULL, 'procedures'),
('procedures_num_item_index', '3', NULL, 'procedures'),
('procedures_num_item_new', '7', NULL, 'procedures'),
('procedures_width_thumb', '150', NULL, 'procedures'),
('products_cat_height_thumb', '150', NULL, 'products'),
('products_cat_width_thumb', '150', NULL, 'products'),
('products_column', '4', NULL, 'products'),
('products_column_cat', '3', NULL, 'products'),
('products_column_index', '5', NULL, 'products'),
...
('products_width_thumb', '150', NULL, 'products'),
...
('menu_procedures', 'ProceduresCat', '', 'listItem', 'Procedures'),
('menu_products', 'ProductsCat', '', 'listItem', 'products'),
('menu_products_index', 'ProductsCat', '', 'listItem', 'products'),
...
('address', 'Địa chỉ : 171/3 Trần Kế Xương, P.7, Q.Phú Nhuận, Thành Phố Hồ Chí Minh', 0, 'vi'),
('add_cart', 'Đặt hàng', 0, 'vi'),
...
('copyright', 'Copyright &copy; 2012 ConnitShop. All rights reserved.', 0, 'vi'),
...
('edit', 'Edit', 0, 'en'),
('edit', 'Chỉnh sửa', 0, 'vi'),
('email', 'Connitshop@gmail.com', 0, 'vi'),
('hidden', 'Hidden', 1, 'en'),
('hidden', 'Ẩn', 1, 'vi'),
('hot', 'nổi bật', 0, 'vi'),
...
('phone', 'Điện thoại : 0909 529 386 - 0937 060 290', 0, 'vi'),
('poll', 'Bình chọn', 0, 'en'),
('poll', 'Bình chọn', 0, 'vi'),
('procedures', 'Thủ tục hành chính', 0, 'vi'),
...
('cau-hoi-thuong-gap', 'jobs', 'vi'),
('chinh-sach-ban-si', 'services', 'vi'),
('gioi-thieu', 'about', 'vi'),
...
('thu-tuc-hanh-chinh', 'procedures', 'vi'),
...
(1, 'Quang cao', 'quang-cao.jpg', '', '2012-12-17 03:26:27', '2012-12-16 17:00:00', '2013-01-27 17:00:00', 0, 1, 'left', '_bank', 0, 1);
...
(1, 'vi', 'Liên hệ với chúng tôi', '<p>Địa chỉ : 171/3 Trần Kế Xương, P.7, Q.Phú Nhuận, Thành Phố Hồ Chí Minh<br />Điện thoại : 0909 529 386 - 0937 060 290<br />Email: Connitshop@gmail.com - Website: Connitshop.com</p>', 'lien-he-voi-chung-toi', 'Địa chỉ : 171/3 Trần Kế Xương, P.7, Q.Phú Nhuận, Thành Phố Hồ Chí Minh\r\nĐiện thoại : 0909 529 386 - 0937 060 290\r\nEmail: Connitshop@gmail.com - Website: Connitshop.com', 0);
...
(36, 'vi', 'Sản phẩm', 'san-pham', 'Sản phẩm'),
(37, 'vi', 'Tin tức', 'su-kien-hot', 'Tin tức'),
(38, 'vi', 'Giới thiệu', 'gioi-thieu', ''),
(41, 'vi', 'Văn bản mới ban hành', 'cau-hoi-thuong-gap', 'Mô tả Văn bản mới ban hành'),
(42, 'vi', 'Quản lý sản phẩm', 'quan-ly-san-pham', ''),
(45, 'vi', 'Liên hệ', 'lien-he', 'Liên hệ'),
(48, 'vi', 'Tài liệu chuyên ngành', 'tai-lieu-chuyen-nganh', ''),
(49, 'vi', 'Thủ tục hành chính', 'thu-tuc-hanh-chinh', 'Thủ tục hành chính');
...
--
-- Table structure for table `hoiit_module_procedures`
--

CREATE TABLE IF NOT EXISTS `hoiit_module_procedures` (
  `record_id` int(11) NOT NULL AUTO_INCREMENT,
  `postdate` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP,
  `pic_thumb` varchar(100) DEFAULT NULL,
  `pic_desc` varchar(500) DEFAULT NULL,
...
--
-- Table structure for table `hoiit_module_procedures_cat`
--

CREATE TABLE IF NOT EXISTS `hoiit_module_procedures_cat` (
  `cat_id` int(11) NOT NULL AUTO_INCREMENT,
  `cat_parent_id` int(11) NOT NULL DEFAULT '0',
  `cat_created` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP,
  `pic_thumb` varchar(100) DEFAULT NULL,
...
--
-- Table structure for table `hoiit_module_procedures_cat_languages`
--

CREATE TABLE IF NOT EXISTS `hoiit_module_procedures_cat_languages` (
  `cat_id` int(11) NOT NULL,
  `language_id` varchar(2) NOT NULL,
  `cat_title` varchar(100) NOT NULL,
  `preview` text,
  ...
  `description` varchar(250) DEFAULT NULL,
  PRIMARY KEY (`cat_id`,`language_id`),
  KEY `fk_hoiit_module_proc_cat_has_hoiit_languages_hoiit_languages1` (`language_id`),
  KEY `fk_hoiit_module_proc_cat_has_hoiit_languages_hoiit_module_ne1` (`cat_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

-- --------------------------------------------------------

--
-- Table structure for table `hoiit_module_procedures_languages`
--

CREATE TABLE IF NOT EXISTS `hoiit_module_procedures_languages` (
  `record_id` int(11) NOT NULL,
  `language_id` varchar(2) NOT NULL,
  `title` varchar(100) NOT NULL,
  `preview` text,
  ...
  `extra_field2` varchar(100) DEFAULT NULL,
  PRIMARY KEY (`record_id`,`language_id`),
  KEY `fk_hoiit_module_proc_has_hoiit_languages_hoiit_languages1` (`language_id`),
  KEY `fk_hoiit_module_proc_has_hoiit_languages_hoiit_module_proc1` (`record_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
--
-- Table structure for table `hoiit_module_products_has_users`
--

CREATE TABLE IF NOT EXISTS `hoiit_module_products_has_users` (
  `record_id` int(11) NOT NULL,
  `user_email` varchar(100) NOT NULL,
  `order_date` timestamp NULL DEFAULT NULL,
  `status` tinyint(1) DEFAULT NULL,
  PRIMARY KEY (`record_id`,`user_email`),
  KEY `fk_hoiit_module_products_has_hoiit_module_products_users_hoii1` (`user_email`),
  KEY `fk_hoiit_module_products_has_hoiit_module_products_users_hoii` (`record_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
--
-- Table structure for table `hoiit_module_products_users`
--

CREATE TABLE IF NOT EXISTS `hoiit_module_products_users` (
  `user_email` varchar(100) NOT NULL,
  `user_pass` varchar(45) NOT NULL,
  `user_fullname` varchar(45) NOT NULL,
  `user_address` varchar(200) NOT NULL,
  `user_cmnd` varchar(45) DEFAULT NULL,
  `user_birthday` timestamp NULL DEFAULT NULL,
  `user_phone` varchar(45) NOT NULL,
  `user_hotline` varchar(45) DEFAULT NULL,
...
--
-- Dumping data for table `hoiit_module_products_users`
--

INSERT INTO `hoiit_module_products_users` (`user_email`, `user_pass`, `user_fullname`, `user_address`, `user_cmnd`, `user_birthday`, `user_phone`, `user_hotline`, `user_sex`, `user_province`, `user_lastvisit`, `user_enable`) VALUES
('groupitsoft@yahoo.com.vn', '14e1b600b1fd579f47433b88e8d85291', 'Dinh Bao', 'Bien hoa', '272119503', NULL, '0942001001', NULL, 1, NULL, NULL, 1);
...
CREATE TABLE IF NOT EXISTS `hoiit_module_services_languages` (
  ...
  `extra_field2` varchar(100) DEFAULT NULL,
  PRIMARY KEY (`record_id`,`language_id`),
  KEY `fk_hoiit_services_languages_hoiit_languages1` (`language_id`),
...
('header', 1, '1', 'about', '', '', 'list_support'),
('top', 2, '1', 'about', '', '', 'news_new'),
('left', 3, '1', 'about', '', '', 'menu_about'),
('left', 4, '1', 'about', '', '', 'adv_left'),
('left', 5, '1', 'about', '', '', 'counter_session'),
('header', 1, '1', 'news', '', '', 'list_support'),
('left', 2, '1', 'news', '', '', 'menu_news'),
('left', 3, '1', 'news', '', '', 'counter_session'),
('left', 4, '1', 'news', '', '', 'adv_left'),
('top', 5, '1', 'news', '', '', 'news_new'),
('left', 1, '1', 'products', '', '', 'menu_products'),
('header', 2, '1', 'products', '', '', 'list_support'),
('left', 3, '1', 'products', '', '', 'adv_left'),
('right', 4, '1', 'products', '', '', 'adv_right'),
('top', 5, '1', 'products', '', '', 'news_new'),
('header', 1, '1', 'jobs', '', '', 'list_support'),
('top', 2, '1', 'jobs', '', '', 'news_new'),
('left', 3, '1', 'jobs', '', '', 'menu_jobs'),
('left', 4, '1', 'jobs', '', '', 'adv_left'),
('left', 5, '1', 'jobs', '', '', 'counter_session'),
('top', 1, '1', 'services', '', '', 'news_new'),
('header', 2, '1', 'services', '', '', 'list_support'),
('left', 3, '1', 'services', '', '', 'menu_services'),
...
('connitshop', 'Con nit shop', '2012-07-26 13:47:49', NULL, 'Con nit shop', NULL, 0, 1);
...
('<jobs:(cau-hoi-thuong-gap)>', 'jobs/default/index', '', 4, 1, 'jobs', 'vi'),
('<jobs:(cau-hoi-thuong-gap)>/<cid:[-a-z0-9]+>', 'jobs/default/cats', '', 3, 0, 'jobs', 'vi'),
('<jobs:(cau-hoi-thuong-gap)>/<cid:[-a-z0-9]+>/<id:[-a-z0-9]+>', 'jobs/default/view', 'urlSuffix=>.html', 0, 0, 'jobs', 'vi'),
('<jobs:(cau-hoi-thuong-gap)>/<cid:[-a-z0-9]+>/trang/<page:\\d+>', 'jobs/default/cats', '', 2, 0, 'jobs', 'vi'),
('<jobs:(cau-hoi-thuong-gap)>/trang/<page:\\d+>', 'jobs/default/index', '', 1, 0, 'jobs', 'vi'),
('<lang:[a-z]{2}>/about-us/<id:[-a-z0-9]+>', 'about/default/view', 'urlSuffix=>.html', 0, 0, 'about', 'en'),
('<news:(su-kien-hot)>', 'news/default/index', '', 5, 1, 'news', 'vi'),
('<news:(su-kien-hot)>/<cid:[-a-z0-9]+>', 'news/default/cats', '', 3, 0, 'news', 'vi'),
('<news:(su-kien-hot)>/<cid:[-a-z0-9]+>/<id:[-a-z0-9]+>', 'news/default/view', 'urlSuffix=>.html', 6, 0, 'news', 'vi'),
('<news:(su-kien-hot)>/<cid:[-a-z0-9]+>/trang/<page:\\d+>', 'news/default/cats', '', 2, 0, 'news', 'vi'),
('<news:(su-kien-hot)>/trang/<page:\\d+>', 'news/default/index', '', 4, 0, 'news', 'vi'),
('<procedures:(thu-tuc-hanh-chinh)>', 'procedures/default/index', '', 5, 1, 'procedures', 'vi'),
('<procedures:(thu-tuc-hanh-chinh)>/<cid:[-a-z0-9]+>', 'procedures/default/cats', '', 3, 0, 'procedures', 'vi'),
...
('<services:(chinh-sach-ban-si)>', 'services/default/index', '', 4, 1, 'services', 'vi'),
('about-us', 'about/default/index', '', 2, 1, 'about', 'en'),
('chinh-sach-ban-si/<id:[-a-z0-9]+>', 'services/default/view', 'urlSuffix=>.html', 1, 0, 'services', 'vi'),
...
--
-- Constraints for table `hoiit_module_procedures`
--
ALTER TABLE `hoiit_module_procedures`
  ADD CONSTRAINT `fk_hoiit_module_proc_hoiit_module_proc_cat_1` FOREIGN KEY (`hoiit_module_item_cat_cat_id`) REFERENCES `hoiit_module_procedures_cat` (`cat_id`) ON DELETE NO ACTION ON UPDATE NO ACTION;

--
-- Constraints for table `hoiit_module_procedures_cat_languages`
--
ALTER TABLE `hoiit_module_procedures_cat_languages`
  ADD CONSTRAINT `fk_hoiit_module_proc_cat__has_hoiit_languages_hoiit_languages1` FOREIGN KEY (`language_id`) REFERENCES `hoiit_languages` (`language_id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  ADD CONSTRAINT `fk_hoiit_module_proc_cat__has_hoiit_languages_hoiit_module_ne1` FOREIGN KEY (`cat_id`) REFERENCES `hoiit_module_procedures_cat` (`cat_id`) ON DELETE NO ACTION ON UPDATE NO ACTION;

--
-- Constraints for table `hoiit_module_procedures_languages`
--
ALTER TABLE `hoiit_module_procedures_languages`
  ADD CONSTRAINT `fk_hoiit_module_proc_has_hoiit_languages_hoiit_languages1` FOREIGN KEY (`language_id`) REFERENCES `hoiit_languages` (`language_id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  ADD CONSTRAINT `fk_hoiit_module_proc_has_hoiit_languages_hoiit_module_proc1` FOREIGN KEY (`record_id`) REFERENCES `hoiit_module_procedures` (`record_id`) ON DELETE NO ACTION ON UPDATE NO ACTION;
...
--
-- Constraints for table `hoiit_module_products_has_users`
--
ALTER TABLE `hoiit_module_products_has_users`
  ADD CONSTRAINT `fk_hoiit_module_products_has_hoiit_module_products_users_hoii` FOREIGN KEY (`record_id`) REFERENCES `hoiit_module_products` (`record_id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  ADD CONSTRAINT `fk_hoiit_module_products_has_hoiit_module_products_users_hoii1` FOREIGN KEY (`user_email`) REFERENCES `hoiit_module_products_users` (`user_email`) ON DELETE NO ACTION ON UPDATE NO ACTION;
...
ALTER TABLE `hoiit_module_services_languages`
  ADD CONSTRAINT `fk_hoiit_services_languages_hoiit_languages1` FOREIGN KEY (`language_id`) REFERENCES `hoiit_languages` (`language_id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  ADD CONSTRAINT `fk_hoiit_services_languages_hoiit_services1` FOREIGN KEY (`record_id`) REFERENCES `hoiit_module_services` (`record_id`) ON DELETE NO ACTION ON UPDATE NO ACTION;
