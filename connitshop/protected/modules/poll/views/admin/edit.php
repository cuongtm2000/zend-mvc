...
<fieldset>
    <legend>Chỉnh sửa bình chọn <?php //echo $this->lang['sys_addpost']       ?></legend>
                    ...
                    <tbody  class="additem">
                        <tr>
                            <td style="text-align:right">
                                Trả lời số <?php echo $i + 1 ?>
                                <input type="hidden" name="Poll[answers][ids][]" value="<?php echo $model->answers['ids'][$i] ?>" />
                            </td>
                            <td>
    ...
    <div class="col1">&nbsp;</div>
    <div class="col2">
        <?php echo CHtml::submitButton('Sửa', array('name' => 'submit', 'class' => 'login', 'title' => 'Add')); ?>
