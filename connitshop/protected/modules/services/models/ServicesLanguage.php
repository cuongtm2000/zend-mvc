...
/**
 * This is the model class for table "hoiit_module_services_languages".
 *
 * The followings are the available columns in table 'hoiit_module_services_languages':
 ...
 */
class ServicesLanguage extends CActiveRecord {
    /**
     * Returns the static model of the specified AR class.
     * @param string $className active record class name.
     * @return ServicesLanguage the static model class
     */
    ...
    public function tableName() {
        return 'hoiit_module_services_languages';
    }
