 ...
 */
class Product_managementLanguage extends CActiveRecord {
    /**
     * Returns the static model of the specified AR class.
     * @param string $className active record class name.
     * @return Product_managementLanguage the static model class
     */
    ...
    public function tableName() {
        return 'hoiit_module_product_management_languages';
    }
