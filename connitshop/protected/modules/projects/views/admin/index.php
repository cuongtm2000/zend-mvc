        ...
        <tbody>
            <?php if ($models): ?>
                <?php $i = 1; foreach ($models as $value): ?>
					...
					<?php if($value['hot'] == 1){$title = '<strong>'.$value->ProjectsLanguage[Yii::app()->language]['title'].'</strong> <img src="'.Yii::app()->theme->baseUrl.'/images/hot.gif" alt="Hot" />'; }else{$title = $value->ProjectsLanguage[Yii::app()->language]['title'];}?>
                    <tr<?php echo $rowclass ?>>
                        ...
                        <td><?php echo $value->ProjectsCat->ProjectsCatLanguage[Yii::app()->language]['cat_title'] ?></td>
                        <td><?php echo $value->ProjectsLanguage[Yii::app()->language]['hit'] ?></td>
