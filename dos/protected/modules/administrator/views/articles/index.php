<ul class="modals"><li><a href="<?php echo Yii::app()->request->baseUrl ?>/<?php echo $this->module->getName() ?>/<?php echo $this->ID ?>/add" title="Add Articles"><img src="<?php echo Yii::app()->theme->baseUrl; ?>/images/add.png" alt="Add Articles" /><span>Add Articles</span></a></li></ul><div class="clear"></div>
            ...
            <?php if ($models): ?>
                <?php $i = 1; foreach ($models as $value): ?>
                    ...
                    <tr<?php echo $rowclass ?>>
                        ...
                        <td><?php echo $value->ArticlesCat->cat_title ?></td>
