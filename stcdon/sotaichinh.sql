...
--
-- Host: localhost
-- Generation Time: Jan 04, 2013 at 09:26 AM
...
('about', 'About us', 0, 'en'),
('about', 'Giới thiệu về Sở Tài chính', 0, 'vi'),
('action', 'Action', 1, 'en'),
...
(5, NULL, '2013-01-04 03:43:23', 6, 0, NULL, NULL, 1),
(6, NULL, '2013-01-04 03:50:07', 5, 0, NULL, NULL, 1),
(7, NULL, '2013-01-04 03:50:42', 4, 0, NULL, NULL, 1),
(8, NULL, '2013-01-04 03:51:19', 3, 0, NULL, NULL, 1),
(9, NULL, '2013-01-04 03:51:48', 2, 0, NULL, NULL, 1),
(10, NULL, '2013-01-04 03:52:11', 1, 0, NULL, NULL, 1);
...
(5, 'vi', 'Chức năng nhiệm vụ', '<p>Đăng cập nhật nội dung</p>', 'chuc-nang-nhiem-vu', '', 25, NULL, NULL),
(6, 'vi', 'Sơ đồ tổ chức', '<p>Đăng cập nhật nội dung</p>', 'so-do-to-chuc', '', 1, NULL, NULL),
(7, 'vi', 'Lãnh đạo Sở', '<p>.....................</p>', 'lanh-dao-so', '', 3, NULL, NULL),
(8, 'vi', 'Các phòng trực thuộc', '<p>.................</p>', 'cac-phong-truc-thuoc', '', 1, NULL, NULL),
(9, 'vi', 'Lãnh đạo Sở qua các thời kỳ', '<p>aaaaaaaaaaaaaaaaaa</p>', 'lanh-dao-so-qua-cac-thoi-ky', '', 1, NULL, NULL),
(10, 'vi', 'Lịch sử tài chính VN và tỉnh nhà', '<p>.............................................</p>', 'lich-su-tai-chinh-vn-va-tinh-nha', '', 1, NULL, NULL);
...
(5, 0, '2013-01-04 07:44:10', '', NULL, 0, 5, NULL, NULL, 1);
...
(3, 'vi', 'Văn bản mới ban hành', '', 'van-ban-moi-ban-hanh', ''),
(4, 'vi', 'Thủ tục hành chính', '', 'thu-tuc-hanh-chinh', 'Tin tiêu điểm'),
(5, 'vi', 'Công khai tài chính', '', 'cong-khai-tai-chinh', '');
...
--
-- Dumping data for table `hoiit_module_procedures`
--

INSERT INTO `hoiit_module_procedures` (`record_id`, `postdate`, `pic_thumb`, `pic_desc`, `record_order`, `hot`, `specials`, `field1`, `field2`, `field3`, `field4`, `enable`, `hoiit_module_item_cat_cat_id`) VALUES
(22, '2012-12-07 07:49:47', '', NULL, 22, 0, NULL, NULL, NULL, NULL, NULL, 1, 7);
...
--
-- Dumping data for table `hoiit_module_procedures_cat`
--

INSERT INTO `hoiit_module_procedures_cat` (`cat_id`, `cat_parent_id`, `cat_created`, `pic_thumb`, `pic_desc`, `cat_hot`, `cat_order`, `cat_extra1`, `cat_extra2`, `cat_enable`) VALUES
(7, 0, '2012-12-07 07:49:30', '', NULL, 0, 7, NULL, NULL, 1);
...
--
-- Dumping data for table `hoiit_module_procedures_cat_languages`
--

INSERT INTO `hoiit_module_procedures_cat_languages` (`cat_id`, `language_id`, `cat_title`, `preview`, `tag`, `description`) VALUES
(7, 'vi', 'Thu tuc hanh chinh', '', 'thu-tuc-hanh-chinh', '');
...
--
-- Dumping data for table `hoiit_module_procedures_languages`
--

INSERT INTO `hoiit_module_procedures_languages` (`record_id`, `language_id`, `title`, `preview`, `content`, `tag`, `description`, `hit`, `extra_field1`, `extra_field2`) VALUES
(22, 'vi', '33_Thẩm định Dự toán chi ngân sách', '<p>33_Thẩm định Dự toán chi ngân sách</p>', '<p>33_Thẩm định Dự toán chi ngân sách</p>', '33tham-dinh-du-toan-chi-ngan-sach', '33_Thẩm định Dự toán chi ngân sách', 0, NULL, NULL);
...
('right', 1, '1', 'about', '', '', 'news_list_first'),
('footer', 2, '1', 'about', '', '', 'counter_session'),
('left', 3, '1', 'about', '', '', 'menu_about'),
('left', 4, '1', 'about', '', '', 'adv_left'),
('left', 1, '1', 'contact', '', '', 'menu_about'),
('left', 2, '1', 'contact', '', '', 'counter_session'),
('right', 3, '1', 'contact', '', '', 'adv_right'),
...
('sotaichinh', 'Sở Tài chính Đồng Nai', '2012-07-26 13:47:49', NULL, 'Yii project', NULL, 0, 1);
...
('admin', '', '14e1b600b1fd579f47433b88e8d85291', NULL, 'Quản lý', '2012-07-03 15:49:55', '2012-07-03 15:49:55', NULL, 1, 'administrator');
