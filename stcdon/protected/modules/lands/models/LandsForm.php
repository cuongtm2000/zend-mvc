...
//    public $unit;
 ...
 //   public $hoiit_module_item_cat_cat_id;
    ...
    public function rules() {
        return array(
            array('hoiit_module_item_cat_cat_id, titlevi,hoiit_module_item_type_type_id, contentvi, ,tagvi,hoiit_module_lands_provinces_province_id,price ', 'required'),
    ...
    public function attributeLabels() {
        return array(
            ...
            'descriptionvi' => 'Mô tả SEO:',
            'contact_name' => 'Tên:',
            'pic_thumb' => 'Hình biểu tượng bài viết',
