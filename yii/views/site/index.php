<div id="header-wrap">
	<div class="frame-title">
		<h1 class="title-page">Make a <img src="<?php echo Yii::app()->theme->baseUrl; ?>/images/free.png" alt="Free" />  &nbsp;Professional Looking Website Today!</h1>
		<p>Use our easy website builder to put your business, group, or personal website online at no cost.</p>
	</div>
	<div id="banner"></div>
	<form action="" class="frm-create" name="frm-create" method="post">
		...
		<ul>
			...
			<li>
				<select size="1" name="website-type">
					<option value="0">Please choose a website type...</option>
					<option value="0">Business</option>
					<option value="0">Group/Organization</option>
					<option value="0">Personal</option>
				</select>
			</li>
			<li><input type="submit" class="get" value="  Get Started  "/></li>
		</ul>
...
<h2 class="title-family">Need a <a href="#" title="">custom Face book Page</a> too? Try <a href="#" title="">Pagemodo</a>, a member of the Webs Family of Products</h2>