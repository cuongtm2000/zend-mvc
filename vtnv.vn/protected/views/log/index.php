    ...
    <tbody>
        ...
        <?php $rowclass = ($i % 2 == 0) ? '' : ' class="alt"'; ?>
                <tr<?php echo $rowclass ?>>
                    ...
                    <td><?php echo ($model['log_type'] == 'thanhtich' || $model['log_type'] == 'chuyenkhoan') ? $model['value'] : 0 ?></td>
                </tr>
                <?php $i++;
            endforeach ?>
<?php endif ?>
...
<br/>
<p class="my-price" style="text-align: right">Số dư tích lũy hiện tại: <span><?php echo number_format($this->balance, 0, '', '.') ?> V</span></p>
