...
<div class="count-module-col1">
	...
	<?php $urls = explode('|', $value['module_url']); $title = explode('|', $value['module_title']); $i = 0; foreach ($urls as $url): ?>
		<p class="sub"><label><a href="<?php echo Yii::app()->request->baseUrl . '/admin/' . $url ?>"><?php echo $title[$i] ?></a>:</label>1<?php //echo $statics->countItem($value['dos_modules_module_id'], $url);?></p>
		<?php $i++; endforeach; ?>
	<?php endforeach; ?>
</div>
